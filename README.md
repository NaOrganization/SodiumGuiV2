...
项目当前重点是 Windows 桌面和 DirectX 11 场景，仓库中包含 Win32 平台 backend、DirectX 11 renderer backend、FreeType 字体 backend，以及桌面应用和 DLL overlay 示例。
...
- C++20 编译支持。
- DirectX 11 SDK 头文件和库，通常由 Windows SDK 提供。
