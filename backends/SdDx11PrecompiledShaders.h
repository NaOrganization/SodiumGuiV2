// Generated from SdDx11Renderer.cpp HLSL. Keep bytecode in sync with shader source when changing the renderer.
#pragma once

#include <cstddef>

namespace Sodium::Backends::PrecompiledShaders
{
	inline constexpr unsigned char kVertexShader[] =
	{
		0x44, 0x58, 0x42, 0x43, 0x65, 0x43, 0x3C, 0xCB, 0xDF, 0x83, 0xCB, 0xEE,
		0x5A, 0x51, 0xA0, 0xFF, 0x48, 0x31, 0x96, 0xEE, 0x01, 0x00, 0x00, 0x00,
		...
		0x74, 0x73, 0x00, 0xAB, 0x3C, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00,
	...
	inline constexpr std::size_t kVertexShaderSize = sizeof(kVertexShader);

	inline constexpr unsigned char kPixelShader[] =
	{
		0x44, 0x58, 0x42, 0x43, 0x07, 0x59, 0x4C, 0x27, 0x25, 0x38, 0x12, 0x31,
		0x64, 0x34, 0xCC, 0xCA, 0x40, 0xF8, 0x14, 0xDF, 0x01, 0x00, 0x00, 0x00,
	...
	inline constexpr std::size_t kPixelShaderSize = sizeof(kPixelShader);
}
